...
import { ICON_MAP, ICON_OPTIONS, CUSTOM_CAT_COLORS } from "../constants/categories.js";

export default function CategoryFormModal({ initialType, editing, onClose, onSave }) {
