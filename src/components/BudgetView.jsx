...
import { Lock, Unlock, ArrowUp, ArrowDown, Check, ChevronLeft, ChevronRight, Copy } from "lucide-react";
import { CurrencyCtx } from "../context.js";
import { fmt, fmtCompact, monthKey, monthLabel, emptyPlan } from "../utils/format.js";
import AmountInput from "./AmountInput.jsx";

export default function BudgetView({ monthPlans, setMonthPlan, viewMonth, setViewMonth, stats, fixedPlan, setFixedPlan, allExpCats, allIncCats }) {
