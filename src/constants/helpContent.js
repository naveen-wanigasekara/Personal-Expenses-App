export const HELP_SECTIONS = [
  ...
  },
  {
    ...
    icon: "📋",
    items: [
      { q: "How are transactions displayed?", a: "Transactions are grouped by date with a daily subtotal. Each entry shows the category icon, description, and amount. Green + = income, red − = expense. Card transactions show a card name badge. Installment transactions show a progress badge (e.g. 3/12)." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What can I see in Card Detail?", a: "Tap any card to see this month's total purchases, payments, and interest; active installment plans with progress bars; a full activity list; and edit/delete options for the card itself." },
      { q: "What are Active Plans in Card Detail?", a: "When you have installment plans running on a card, an Active Plans section appears at the top of Card Detail. Each plan shows the label, monthly amount, how many installments have been paid vs. the total, and a progress bar. You can cancel a plan from here." },
      { q: "How do I cancel an installment plan?", a: "In Card Detail, find the plan under Active Plans and tap Cancel. Past installment transactions are kept exactly as they are. Future installments (months after the current one) are deleted and the card balance updates accordingly." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do installment plans affect my budget?", a: "Yes. Since all monthly installment transactions are pre-created, future months will already show spending in the relevant category. This means the budget for that category will reflect upcoming installments automatically — helping you plan ahead and avoid overspending." },
    ],
  },
  {
    id: "insights",
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Using installment plans effectively", a: "Create an installment plan at the time of purchase, not later. The app pre-fills all future months immediately, so your balance and budget reflect the full commitment right away. Use Card Detail to monitor progress and cancel plans early if you pay off the balance." },
      ...
      { q: "Checking upcoming commitments", a: "Tap the bell icon on the Insights tab at the start of each month to see installment payments due and any other reminders. This gives you a quick view of fixed outgoings before you start spending." },
